...
from myhls4ml.writer.writers import Writer
...
class VivadoWriter(Writer):
    ...
    def write_nnet_utils(self, model):
        ...
        # ram_table_utils
        filedir = os.path.dirname(os.path.abspath(__file__))
        srcpath = os.path.join(filedir, '../templates/vivado/ram_table_utils/')
        dstpath = f'{model.config.get_output_dir()}/firmware/ram_table_utils/'
